...
public static class UiLabels
{
    ...
    public const string ScreenshotNotSavedNotification = "画像を保存しませんでした。";
    public const string ScreenshotNotSavedClipboardNotification = "画像は保存しませんでしたが、クリップボードにコピーしました。";
    public const string ScreenshotNotSavedClipboardFailedNotification = "画像は保存せず、クリップボードにもコピーできませんでした。";
    ...
    public const string SaveDirectoryStillImageTitle = "静止画の保存先を確認してください";
    public const string SaveDirectoryVideoTitle = "動画の保存先を確認してください";
    public const string SaveDirectoryHelp = "あとから設定画面で変更できます。";
    public const string SaveDirectoryChange = "変更...";
    public const string SaveDirectoryConfirm = "このフォルダーに保存";
    public const string SaveDirectoryChecking = "確認しています...";
    public const string SaveDirectoryChooseUnprotected = "保護されていない場所に作る";
    public const string SaveDirectoryChooseAnother = "別のフォルダーを選ぶ";
    public const string SaveDirectoryOpenSecurity = "Windows セキュリティを開く";
    public const string SaveDirectoryFailureReason = "保存先へ書き込めませんでした: {0}";
    public const string SaveDirectoryCheckingCandidate = "確認しています: {0}";
    public const string SaveDirectoryProtectionHelp = "Windows セキュリティの「コントロールされたフォルダー アクセス」などの保護機能によって、ピクチャやビデオへの書き込みが止められている可能性があります。別のフォルダーを選ぶか、保護機能の設定を確認してください。";
    public const string SaveDirectoryFallbackFailed = "候補のフォルダーにも保存できませんでした。別のフォルダーを選んでください。";
    public const string SaveDirectoryNoFallbackCandidates = "利用できる候補のフォルダーがありません。別のフォルダーを選んでください。";
    public const string SaveDirectorySecurityOpened = "Windows セキュリティを開きました。";
    public const string SaveDirectorySecurityOpenFailedReason = "Windows セキュリティの起動を確認できませんでした。";
    public const string SaveDirectorySecurityOpenFailed = "Windows セキュリティを開けませんでした: {0}";
