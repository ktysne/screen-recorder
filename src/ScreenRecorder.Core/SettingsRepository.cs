...
public sealed class SettingsRepository(string? baseDirectory = null)
{
    ...
    public Settings Load()
    {
        ...
        try
        {
            ...
            result.ConfirmedStillImageDirectory = NullableString(root, nameof(result.ConfirmedStillImageDirectory), defaults.ConfirmedStillImageDirectory);
            ...
            result.ConfirmedVideoDirectory = NullableString(root, nameof(result.ConfirmedVideoDirectory), defaults.ConfirmedVideoDirectory);
